...
from src.DeepQA.pipeline.Stage_03_Data_Transformation import \
    DataTransformationPipeline
from src.DeepQA.pipeline.Stage_04_Model_Trainer import ModelTrainerPipeline
from src.DeepQA.pipeline.Stage_05_Model_Evaluation import \
    ModelEvaluationPipeline
from src.DeepQA.pipeline.Stage_06_Model_Prediction import \
...
if __name__ == "__main__":
    try:
        ...
        training.main()
        logger.info(
            f"-----------stage {STAGE_NAME1} completed successfully ---------<<\n\n----"
        )
...
if __name__ == "__main__":
    try:
        ...
        training.main()
        logger.info(
            f"-----------stage {STAGE_NAME2} completed successfully ---------<<\n\n----"
        )
    except Exception as e:
        logger.exception(e)
        raise e
...
if __name__ == "__main__":
    try:
        ...
        training.main()
        logger.info(
            f"-----------stage {STAGE_NAME3} completed successfully ---------<<\n\n----"
        )
    except Exception as e:
        logger.exception(e)
        raise e
...
if __name__ == "__main__":
    try:
        ...
        training.main()
        logger.info(
            f"-----------stage {STAGE_NAME4} completed successfully ---------<<\n\n----"
        )
    except Exception as e:
        logger.exception(e)
        raise e
...
if __name__ == "__main__":
    try:
        ...
        training.main()
        logger.info(
            f"-----------stage {STAGE_NAME5} completed successfully ---------<<\n\n----"
        )
    except Exception as e:
        logger.exception(e)
        raise e
...
if __name__ == "__main__":
    try:
        ...
        training.main()
        logger.info(
            f"-----------stage {STAGE_NAME6} completed successfully ---------<<\n\n----"
        )
    except Exception as e:
        logger.exception(e)
        raise e
